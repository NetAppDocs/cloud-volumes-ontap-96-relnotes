...
^1^ These instance types include local NVMe storage, which Cloud Volumes ONTAP uses as _Flash Cache_. https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-flash-cache.html[Learn more^].
...
* https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-gcp.html[Learn how to get started in Google Cloud^]
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-tiering.html[Learn how to set up data tiering in Cloud Manager^].
